...
public class FakeTxBuilder {
    ...
    /**
     * @return Transaction[] Transaction[0] is a feeder transaction, supplying NBC to Transaction[1]
     */
    public static Transaction[] createFakeTx(NetworkParameters params, BigInteger nanocoins,
                                             Address to, Address from) {
        // Create fake TXes of sufficient realism to exercise the unit tests. This transaction send NBC from the
